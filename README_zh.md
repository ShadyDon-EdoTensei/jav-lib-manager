...
- 👩 **女优头像** - 浏览 945+ 女优头像资料（罩杯、身高、出生年），支持批量下载
...
点击任意视频卡片查看：
- 高清封面大图（点击可查看全尺寸）
- 女优名字可点击，直接查看头像和资料（罩杯、身高、出生年）
- 标签分类
- 文件信息（路径、大小、日期）

#### 女优头像浏览

1. 点击工具栏中的 **"女优头像"** 按钮，打开女优头像浏览窗口
2. 浏览 945+ 女优头像卡片，支持按名字搜索或"仅显示有头像"筛选
3. 点击 **"下载所有头像"** 批量下载缺失的头像到本地
4. 在视频详情面板中，女优名字是可点击的粉色链接，点击可查看头像和资料
5. 双击女优卡片可直接过滤主窗口视频列表，显示该女优的所有作品
